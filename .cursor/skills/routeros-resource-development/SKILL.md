...
4. Pass `context.Context` through every network operation. Return errors with the resource and operation while preserving the wrapped cause.
...
7. Run formatting, the affected package tests, and `go test ./...`.
