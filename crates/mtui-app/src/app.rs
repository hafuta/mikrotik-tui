...
use mtui_core::{
    ...
    installed_package_names, is_missing_command_prefix, resource_by_id,
...
impl App {
    ...
    fn refresh_unavailable_menus(&mut self) {
        ...
        let mut missing = unavailable_menus_for_device(&self.installed_packages, &arch, &cpu);
        for id in &self.missing_path_ids {
            missing
                .entry(id.clone())
                .or_insert_with(|| MISSING_PATH_REASON.to_string());
        }
