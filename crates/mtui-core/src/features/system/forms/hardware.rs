    ...
    sections: &[
        FormSection {
            ...
            fields: &[
                ...
                f!("nfs-address", "NFS Address", FieldKind::Ip),
                f!("nfs-share", "NFS Share", FieldKind::Text),
                f!("smb-address", "SMB Address", FieldKind::Ip),
                ...
                f!("nvme-tcp-address", "NVMe TCP Address", FieldKind::Ip),
                ...
                f!("iscsi-address", "iSCSI Address", FieldKind::Ip),
