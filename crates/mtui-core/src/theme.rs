...
impl DefaultTheme {
    ...
    pub fn new() -> Self {
        Self {
            ...
            palette: Palette {
                void: ColorRgb::from_hex("#090D13").expect("valid hex"),
                panel: ColorRgb::from_hex("#121A26").expect("valid hex"),
                text: ColorRgb::from_hex("#DCE7F3").expect("valid hex"),
                ...
                muted: ColorRgb::from_hex("#7F8D9E").expect("valid hex"),
                border: ColorRgb::from_hex("#293849").expect("valid hex"),
