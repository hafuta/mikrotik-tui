...
static LEGACY_RESOURCES: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        ...
        form: Some(&crate::system_write::LICENSE_FORM),
    },
    ResourceSpec {
        id: "disks",
        group: "system-group",
        ...
        form: Some(&crate::system_write::DISK_FORM),
    },
    ResourceSpec {
        id: "device-mode",
        group: "system-group",
        ...
        refresh: Duration::from_secs(30),
        actions: crate::actions::SINGLETON_EDIT_ACTIONS,
        form: Some(&crate::system_write::DEVICE_MODE_FORM),
    },
    ResourceSpec {
        id: "user-groups",
        group: "system-group",
...
/// Active hybrid catalog: feature-owned groups first, then unchanged legacy groups.
...
mod tests {
    ...
    fn hybrid_catalog_includes_the_entire_feature_inventory() {
        ...
        assert_eq!(LEGACY_RESOURCES[0].id, "users");
    }
